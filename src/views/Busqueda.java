...
public class Busqueda extends JFrame {
		...
		btnEliminar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(filaReservas >= 0) {
					...
					int confirmarR = JOptionPane.showConfirmDialog(null, "¿Desea Eliminar los datos?");					
	...
	// METODOS PARA CONECTAR EL BACK CON EL FRONT
	...
	private void llenarTablaReservas() {
		...
		try {
			...
			for(Reserva reservas : reserva) {
				modeloReserva.addRow(new Object[] { reservas.getId(), reservas.getFechaE(), reservas.getFechaS(), reservas.getValor(), reservas.getFormaPago() });				
			}
		}catch(Exception e) {
			throw e;
		}
	...
	private void actualizarHuesped() {		
		...
		.ifPresentOrElse(filaHuesped -> {
			...
			Date fecha_nacimiento = Date.valueOf(modeloHuesped.getValueAt(tbHuespedes.getSelectedRow(), 3).toString());
			String nacionalidad = (String) modeloHuesped.getValueAt(tbHuespedes.getSelectedRow(), 2);
			...
			this.huespedesController.actualizar(nombre, apellido, fecha_nacimiento, nacionalidad, telefono, idReserva, id);
	...
	private void actualizarReservas() {
		...
		.ifPresentOrElse(fila -> {
			...
			JOptionPane.showMessageDialog(this, String.format("El Registro se Modifico Exitosamente!"));
		}, () -> JOptionPane.showMessageDialog(this, "Por Favor Elije un Registro!"));
	}
